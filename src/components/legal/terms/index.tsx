export default function TermsPage() {
	return (
		<main className="mx-auto flex max-w-screen-xl flex-col !gap-4 px-4 md:p-8 ">
			...
			<p className="text-lg font-bold">Interpretation and Definitions</p>
			...
			<p>
				<span className="font-bold">Country</span> refers to: New York,
				United States
			</p>

			<p>
				<span className="font-bold">Owner</span> (referred to as either
				&quot;the Owner,&quot; &quot;We,&quot; &quot;Us,&quot; or
				&quot;Our&quot; in this Agreement) refers to Umut YILDIRIM
			</p>
			...
			<p>
				...
				accessing or using the Service, or the Owner, or other legal
			...
			<p>
				...
				Owner. These Terms and Conditions set out the rights and
			...
			<p>
				...
				Owner. Our Privacy Policy describes Our policies and procedures
			...
			<p>
				By using this site and buying credits, you agree to our refund
				policy and will not seek to ask for refunds if you are unhappy
				with the results of your AI-generated icons or brand names. You
				understand the limitations of AI art. Some of these limitations
				include an inability to generate letters and characters, often
				misinterprets prompts, often might have deformed results, etc.
				When buying credits, you accept the risk that some AI-generated
				icons or brand names may not be perfect. By using this site you
				might have to pay additional fees to your bank.
			</p>

			<p className="font-bold">Links to Other Websites</p>
			<p>
				Our Service may contain links to third-party websites or
				services that are not owned or controlled by the Owner.
			</p>

			<p>
				The Owner has no control over, and assumes no responsibility
				for, the content, privacy policies, or practices of any
				third-party websites or services. You further acknowledge and
				agree that the Owner shall not be responsible or liable,
			...
			<p className="font-bold">Icon and Brand Generation</p>
			<p>
				We can use your icons or brand names to promote our service.
				This includes, but is not limited to: online ads, physical ads,
				social media posts, and anywhere inside this application.
			</p>
			...
			<p>
				Our service uses AI provided by OpenAI to generate brand names.
				Please review copyright laws for your country and state in
				regards to AI generated art or images. By using our services,
				you agree that our Owner and service assume no responsibility
				for the images generated. Nor do we assume responsibility for
				damages or loss caused by these images.
			</p>

			<p>
				Notwithstanding any damages that You might incur, the entire
				liability of the Owner and any of its suppliers under any
			...
			<p>
				...
				shall the Owner or its suppliers be liable for any special,
				...
				Terms), even if the Owner or any supplier has been advised of
			...
			<p>
				...
				law, the Owner, on its own behalf and on behalf of its
				...
				the Owner provides no warranty or undertaking, and makes no
			...
			<p>
				...
				Owner&apos;s provider makes any representation or warranty of
				...
				content, or e-mails sent from or on behalf of the Owner are free
			...
			<p className="font-bold">Disputes Resolution</p>
			<p>
			...
			<p className="font-bold">For European Union (EU) Users</p>
			<p>
			...
			<p className="font-bold">United States Legal Compliance</p>
			<p>
			...
			<p className="font-bold">Severability and Waiver</p>
			...
			<p className="font-bold">Translation Interpretation</p>
			<p>
			...
			<p className="font-bold">Changes to These Terms and Conditions</p>
			<p>
